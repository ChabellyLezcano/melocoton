const { sendChangeToAdminEmail, sendChangeToCurrentEmail, sendAccountStatusBlockedEmail, sendAccountStatusActiveEmail } = require("../helpers/email");
...
const listUsers = async (req, res) => {
  ...
  const changeToAdmin = async (req, res) => {
    try {
      ...
      const requestingUser = req.params; // Obtén el usuario que realiza la solicitud
