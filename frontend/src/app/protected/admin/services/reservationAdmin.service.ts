...
export class ReservationService {
  ...
  acceptReservation(
    ...
    const url = `${this.baseUrl}/reservationAdmin/reservations/accept/${reservationId}`;
    const headers = new HttpHeaders().set(
      'token',
      localStorage.getItem('token') || ''
    );
  ...
  rejectReservation(
    ...
    const url = `${this.baseUrl}/reservationAdmin/reservations/reject/${reservationId}`;
    const headers = new HttpHeaders().set(
      'token',
      localStorage.getItem('token') || ''
    );
  ...
  markAsPickedUp(reservationId: string): Observable<ReservationResponse> {
    const url = `${this.baseUrl}/reservationAdmin/reservations/mark-as-picked-up/${reservationId}`;
    const headers = new HttpHeaders().set(
      'token',
      localStorage.getItem('token') || ''
    );
  ...
  markAsCompleted(reservationId: string): Observable<ReservationResponse> {
    const url = `${this.baseUrl}/reservationAdmin/reservations/mark-as-completed/${reservationId}`;
    const headers = new HttpHeaders().set(
      'token',
      localStorage.getItem('token') || ''
    );
